...
try:
    dravidian_translator = pipeline("translation", model="Helsinki-NLP/opus-mt-en-dra")
...
def translate_text(text, target_language='bengali'):
    ...
    for chunk in text_chunks:
        try:
            translation = translator(prefix + chunk, max_length=512) 
